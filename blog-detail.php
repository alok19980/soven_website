        ...
        <div class="row d-flex justify-content-center">
          <div class="col-md-12">
            <div class="header-inner-title text-center position-relative">
              <h1 class="text-white fw-normal mb-0">From a small startup to a leading global agency in 10 Years.</h1>
            </div>
          </div>
        </div>
      </div>
            ...
            <div class="blog-detail">
                ...
                <div class="blog-post-content">
                  ...
                  <div class="blog-post-details">
                    ...
                    <ul class="list list-unstyled">
                      <li class="d-flex"><i class="fas fa-check pe-2 pt-1 text-primary"></i><span>Use a past defeat as a motivator. Remind yourself you have nowhere to go except</span></li>
                      <li class="d-flex"><i class="fas fa-check pe-2 pt-1 text-primary"></i><span>Give yourself the power of responsibility. </span></li>
                      <li class="d-flex"><i class="fas fa-check pe-2 pt-1 text-primary"></i><span>Remind yourself the only thing stopping you is yourself.</span></li>
                      <li class="d-flex"><i class="fas fa-check pe-2 pt-1 text-primary"></i><span>Make a list of your achievements toward your long-term</span></li>
                      <li class="d-flex"><i class="fas fa-check pe-2 pt-1 text-primary"></i><span>goal and remind yourself that intentions don’t count, only action’s.</span></li>
                    </ul>
                  </div>
                </div>
              </div>
                  ...
                  <div class="blog-post-details">
                    ...
                    <div class="d-sm-flex align-items-center">
                      <div class="blog-post-meta pe-4">
                        <a href="#"><i class="far fa-heart pe-1"></i>14</a>
                        <a href="#"><i class="far fa-eye pe-1"></i>21</a>
                        <a href="#"><i class="far fa-comments pe-1"></i>03</a>
                      </div>
              ...
              <div class="navigation post-navigation my-md-4">
                <div class="nav-previous">
                  <a href="#" class="btn btn-light-round right-round btn-round"><i class="fas fa-arrow-left pe-3"></i><span>Five initial steps you must do to increase your business incomes</span></a>
                </div>
                <div class="nav-next">
                  <a href="#" class="btn btn-primary-round btn-round"><span>How google’s BERT algorithm affects your website traffic</span><i class="fas fa-arrow-right ps-3"></i></a>
                </div>
              </div>
              <hr>
