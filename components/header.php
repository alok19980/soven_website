            ...
            <div class="col-12">
              <div class="d-block d-md-flex align-items-center text-center">
                <div class="me-4 d-inline-block py-1">
                  <a href="#"><i class="far fa-envelope me-2 fa-flip-horizontal text-primary"></i>admin@sovendeveloper.com</a>
                </div>
                <div class="me-auto d-inline-block py-1">
                  <a><i class="fas fa-map-marker-alt text-primary me-2"></i>2055 Limestone Rd STE 200-C, Wilmington, DE 19808, United States</a>
                </div>
